...
misc/redirectToUrl.php?url=http://dev.piwik.org/'>create a ticket</a> in our developer area (attach the client code to the ticket).
...
misc/redirectToUrl.php?url=http://piwik.org/docs/tracking-api/' target='_blank'>in the documentation</a>
	</p>
<?php endif; ?>
</div>
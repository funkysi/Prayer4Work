...
<?php endif; ?>
<!--<h2 class="page-title author clear"><?php printf( __( 'Posts by %s', '' ), "<span class='vcard'>" . get_the_author() . "</span>" ); ?></h2>--><?php rewind_posts();?>
	...
	<p class="postmetadata"><?php if (get_option('desk_hidetags') == '') { the_tags('<span class="tags">Tags: ', ', ', '</span><br />'); } ?>
